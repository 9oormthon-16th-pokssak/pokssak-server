...
import com.goormthon.auth.AuthenticationProperties
import com.goormthon.auth.GrantedAuthority
import com.goormthon.auth.Provider
import com.goormthon.auth.RedisTokenRepository
import com.goormthon.auth.Token
import com.goormthon.auth.TokenRepository
...
@Component
class JwtProvider(
    @Value("\${jwt.secret-key:goormthonJwtSecretKeyForAuthenticationSecuritySystem2024SecureKey!@#\$}")
    ...
    companion object {
        private const val ISSUER = "goormthon"
