package com.goormthon.support.tx
...
class Tx(
    ...
    companion object {
        ...
        fun <T> notSupported(function: () -> T): T {
            return txAdvice.notSupported(function)
        }
        fun <T> never(function: () -> T): T {
            return txAdvice.never(function)
        }
    }
